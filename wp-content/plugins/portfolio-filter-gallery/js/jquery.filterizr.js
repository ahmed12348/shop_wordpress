            ...
            return T(e, t), e.prototype.initialize = function() {
                ...
                this.set(function(t, e) {
                    return Object.assign({}, e, {
						transform: (e.transform || "") + " translate3d(" + t.left + "px, " + t.top + "px, 0) scale3d(" + e.opacity + ", " + e.opacity + ", 1 )"
                    })
                }(t, e))
                ...
                this.set((t = this._index, e = this.options, {
					...
					//transitionDuration: (n = e.get()).animationDuration + "s"
                }))
                ...
                this.remove("transition-duration")
